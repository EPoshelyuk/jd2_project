...
<div class="row">
    <div class="col-sm-10" style="margin-left: 2%"><h1>Sensor table</h1></div>
...
<div class="col-md-12" style="line-height: 1.5">
    <table class="table table-striped" style="width:80%">
        ...
        <tr>
            ...
            <td><a href="/allsensors/edit/${sensorDTO.sensorId}" data-toggle="tooltip" data-placement="right"
            ...
            <@security.authorize access="hasAuthority('ADMIN')">
                <td class="minimal_cell">
                    <a href="/allsensors/edit/${sensorDTO.sensorId}" title="Edit">
                    ...
                    <a href="/allsensors/delete/${sensorDTO.sensorId}" title="Delete">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#B22222" class="bi bi-trash-fill" viewBox="0 0 16 16">
...
<@security.authorize access="hasAuthority('ADMIN')">
    <form action="/allsensors/add">
        <button type="submit" class="btn btn-primary btn-sm"
                style="height:40px;width:150px; margin-left: 10%;margin-top:10px; background: #4682B4;border-color: #4682B4  ">Add Sensor
        </button>
    </form>
</@security.authorize>
